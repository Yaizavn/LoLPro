...
public class Patrones {
    ...
    private final static String PCHAMPION = "id\":([0-9]+).*?name\":\"(.+?)\".*?title\":\"(.+?)\".*?full\":\"(.+?)\".*?lore\":\"(.+?)\".*?partype\":\"(.+?)\".*?armor\":([0-9]+\\.[0-9]+|[0-9]+).*?armorperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?attackdamage\":([0-9]+\\.[0-9]+|[0-9]+).*?attackdamageperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?attackrange\":([0-9]+\\.[0-9]+|[0-9]+).*?attackspeedoffset\":(-?0\\.[0-9]+|0).*?attackspeedperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?crit\":([0-9]+\\.[0-9]+|[0-9]+).*?critperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?hp\":([0-9]+\\.[0-9]+|[0-9]+).*?hpperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?hpregen\":([0-9]+\\.[0-9]+|[0-9]+).*?hpregenperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?movespeed\":([0-9]+\\.[0-9]+|[0-9]+).*?mp\":([0-9]+\\.[0-9]+|[0-9]+).*?mpperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?mpregen\":([0-9]+\\.[0-9]+|[0-9]+).*?mpregenperlevel\":([0-9]+\\.[0-9]+|[0-9]+).*?spellblock\":([0-9]+\\.[0-9]+|[0-9]+).*?spellblockperlevel\":([0-9]+\\.[0-9]+|[0-9]+)";
