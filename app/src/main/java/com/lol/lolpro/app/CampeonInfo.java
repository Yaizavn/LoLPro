...
public class CampeonInfo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (datos != null){
            ...
            ((TextView) view.findViewById(R.id.regVida)).setText(datos[5]);
            //((TextView) view.findViewById(R.id.regVidaPorNivel)).setText(datos[6]);
            ((TextView) view.findViewById(R.id.danioAtaque)).setText(datos[7]);
            //((TextView) view.findViewById(R.id.danioAtaquePorNivel)).setText(datos[8]);
            ((TextView) view.findViewById(R.id.armadura)).setText(datos[9]);
            //((TextView) view.findViewById(R.id.armaduraPorNivel)).setText(datos[10]);
            ((TextView) view.findViewById(R.id.velAtaque)).setText(datos[11]);
            //((TextView) view.findViewById(R.id.velAtaquePorNivel)).setText(datos[12]);
            //((TextView) view.findViewById(R.id.crit)).setText(datos[13]);
            //((TextView) view.findViewById(R.id.critPorNivel)).setText(datos[14]);
            //((TextView) view.findViewById(R.id.mana)).setText(datos[15]);
            //((TextView) view.findViewById(R.id.manaPorNivel)).setText(datos[16]);
            //((TextView) view.findViewById(R.id.regMana)).setText(datos[17]);
            //((TextView) view.findViewById(R.id.regManaPorNivel)).setText(datos[18]);
            ((TextView) view.findViewById(R.id.resMagica)).setText(datos[19]);
            //((TextView) view.findViewById(R.id.resMagicaPorNivel)).setText(datos[20]);
            ((TextView) view.findViewById(R.id.velMov)).setText(datos[21]);
